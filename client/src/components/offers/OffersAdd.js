    ...
    render(){
        ...
        return(
            <li>
                ...
                <Modal className = "modal"l
                isOpen={this.state.modalIsOpen}
                onAfterOpen={this.afterOpenModal}
                onRequestClose={this.closeModal.bind(this)}
                       style={customStyles}>
        
                <h2 ref="subtitle">Add Offer- FOR_FAST ADDING TO DB, FOR TEST PURPOSES ONLY</h2>
                    <Link onClick={this.closeModal.bind(this)} to = "/" > Return </Link>
                    <form onSubmit={this.handleSubmit.bind(this)}>
            
                    <input type="text" id="fname" ref="companyName" placeholder="Company Name"/>
                        <input type="text" id="lname" ref="customerAdress" placeholder="Adress"/>
