...
class OfferDetail extends React.Component {
    ...
    renderButtons(){
        if(!this.props.activeOffer._id){
            ...
            return (
                <a href="#" onClick= {this.handleDeleteClick(this.props.activeOffer._id)} className="btn btn-default"> Delete</a>
            );
        }
    }
    ...
    renderOffer(){
        ...
        if(!this.props.activeOffer._id){
            ...
            return (
                <p>{companyName}, {customerAdress}, {item}</p>
            );
        }
    }
        ...
        return(
            <div>
                ...
                <div className="top-sold">
                    ...
                    <ul>
                        {this.renderMostSoldOffers(this.props.offers)}
                    </ul>
                </div>
